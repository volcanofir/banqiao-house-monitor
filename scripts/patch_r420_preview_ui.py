...
<section class="panel r420-panel" id="r420Panel" hidden>
  ...
  <div class="inside">
    ...
    <div class="note">Preview 專用。案件依行政區收整，板橋區優先顯示；各區預設收合，避免 72 筆案件把頁面拉太長。</div>
    ...
    <div class="r420-tools">
      <select id="r420District"><option value="all">全部地區</option></select>
...
required = ['id="r420Panel"','id="r420Total"','id="r420District"','r420-widget.css','r420-widget.js']
